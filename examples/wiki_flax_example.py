...
def make_ps_trainer(args):
    trainer = ParameterServerStrategy(
        ...
        max_iteration=3000,
        record_config={
            "batch_size": 8 * (args.num_workers-args.num_ps),
...
if __name__ == "__main__":
    ...
    if args.address:
        ...
        ray.init(num_gpus=args.num_workers, num_cpus=args.num_workers*2, log_to_driver=True, resources={"server":args.num_ps})
