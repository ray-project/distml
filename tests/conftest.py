...
#
# from tests.torch_util import ToyOperator, initialization_hook
#
...
#                 if i < j:
#                     p2p_communicator_key = \
#                     _get_comm_key_send_recv(i, 0, j, 0)
...
#
# @pytest.fixture
# def ray_start_single_node_4_gpus():
#     # Please start this fixture in a cluster with 2 GPUs.
#     address_info = ray.init(num_gpus=4)
#     yield address_info
#     ray.shutdown()
#
#
